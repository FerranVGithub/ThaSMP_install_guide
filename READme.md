...
### Upload the downloaded instance to modrinth/curseforge:
 * Modrinth:
	* Step 1: Go to `Library` and click the + to add a modpack.
   		![image](https://github.com/user-attachments/assets/31276987-ed65-4e93-a01f-243cc1b5d658)

	* Step 2: Press `From file`
   		![image](https://github.com/user-attachments/assets/2157f508-7a85-462b-bc22-3e9d4ce1ab2c)

  	 * Step 3: Drop your downloaded file in and you should be set!
	  
* CurseForge:
  	* Step 1: Press `Import`
     	  ![image](https://github.com/user-attachments/assets/ac2930c6-4dbe-434c-a483-ccac43e1dba8)

	* Step 2: Press `Choose .zip file`
   	![image](https://github.com/user-attachments/assets/416ea4cb-3a37-4c6f-a017-b19638633df3)

   	* Step 3: Select the .zip file you downloaded and you should be set!
